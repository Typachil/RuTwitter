...
buttonsComment.forEach(function (buttonItem) {
  return buttonItem.addEventListener('click', function (e) {
    e.preventDefault();
    var formComment = e.target.closest('.post').querySelector('.form-comment');
    formComment.style.display = 'flex';
  });
});
buttonsShowComments.forEach(function (buttonItem) {
  return buttonItem.addEventListener('click', function (e) {
    e.preventDefault();
    var listComments = e.target.closest('.post').querySelector('.comments-list');
    listComments.style.display = 'block';
  });
});
buttonsShowSettingsEdit.forEach(function (buttonItem) {
  return buttonItem.addEventListener('click', function (e) {
    e.preventDefault();
    var currentBlock = e.target.closest('.block');
    var formEdit = currentBlock.querySelector('.form-edit');
    var blockChange = currentBlock.querySelector('.block-change');
    formEdit.style.display = 'flex';
    blockChange.style.display = 'none';
  });
});
buttonsLikePost.forEach(function (buttonItem) {
  return buttonItem.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
      var valueLikesSpan, data, reponse, result;
